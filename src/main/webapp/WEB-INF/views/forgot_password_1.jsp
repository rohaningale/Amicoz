...
<body>
  ...
  <div id="formbox">
  <div id="userInput">
	<form id="forgot_password_form_1" action="/forgot_password_1" method="POST">
<!-- 	<p>Please provide your email to find the password.</p> -->
	...
	<a onclick="document.getElementById('forgot_password_form_1').submit();"><input type="submit" value="Next >>"></a><br>
